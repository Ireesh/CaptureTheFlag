...
```bash
> sqlmap -u  “https://target.com/fetch?id=1” -p id –batch –risk 3 –dbs
...
I will use ‘id=0’ for negative and ‘id=1’ for positive results.
Second, we need to research the ‘uwsgi-nginx-flask-docker’ branch on github, for example, to understand what we can use with ‘UNION’ like payload.
